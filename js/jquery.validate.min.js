  ...
  const detectMessages = () => {
    if (lang === "en") {
      ...
      return {
        ...
        maxlength: a.validator.format("الرجاء إدخال ما لا يزيد عن {0} حرف."),
        minlength: a.validator.format("الرجاء إدخال {0} حرف على الأقل."),
        rangelength: a.validator.format(
          "الرجاء إدخال قيمة يتراوح طولها بين {0} و {1} حرفًا."
        ),
        range: a.validator.format("الرجاء إدخال قيمة بين {0} و {1}."),
        max: a.validator.format("الرجاء إدخال قيمة أقل من أو تساوي {0}."),
        min: a.validator.format("الرجاء إدخال قيمة أكبر من أو تساوي {0}."),
        step: a.validator.format("الرجاء إدخال مضاعفات {0}.")
      };
    }
  };
  a.extend(a.fn, {
