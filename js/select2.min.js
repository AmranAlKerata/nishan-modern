        ...
        s = (
            ...
            u.define("select2/results", ["jquery", "./utils"], function (d, p) {
                ...
                return p.Extend(s, p.Observable), (s.prototype.render = function () {
                    ...
                    for (n in (
                        ((null != e.element && i.call(e.element, ":disabled")) ||
                ...
                function (e, t, n, s) {
                    ...
                    return n.Extend(i, t), (i.prototype.render = function () {
                        ...
                        return e[0].classList.add("select2-selection--single"), e.html(
                            '<span class="select2-selection__rendered border-effect"></span><span class="focus-border"><i></i></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>'
                        ), e;
            ...
            u.define(
                ...
                function (e, t, c) {
                    function s(e, t) {
                        (this._dataToConvert =
                            t.get("data") || []), s.__super__.constructor.call(this, e, t);
                    }
                        ...
                        for (var n = new g(), s = 0; s < e.length; s++) {
                            ...
                            if ("string" == typeof r)
                                try {
                                    ...
                                    try {
                                        (r = this.defaults.amdLanguageBase + r), (i = g.loadPath(
                                            r
                                        ));
                                    } catch (e) {
                                        t &&
